    ...
    <footer className="border-t border-slate-800/60 py-16">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-slate-400 text-sm leading-relaxed max-w-xs">
              The AI-powered workspace that helps modern teams automate, collaborate, and ship faster.
            </p>
        ...
        <div className="border-t border-slate-800/60 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-slate-500 text-sm">© 2024 NovaSpark, Inc. All rights reserved.</p>
